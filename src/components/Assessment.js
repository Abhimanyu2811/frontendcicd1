...
const Assessment = () => {
  ...
  if (loading) {
    return (
      <div className="container bg-black mt-5 text-center">
  ...
  if (submitted && result) {
    return (
      <div className="create-assessment-container bg-black container mt-5 text-center border shadow font font-color">
        <div className="p-4">
...
return (
  ...
  <div className="root bg-black">
    <div
      className="create-assessment-container container mt-5 shadow"
      style={{ backgroundColor: "#000", color: "#fff", padding: "2rem", borderRadius: "1rem" }}
    >
      <div className="mb-4">
      ...
      <div className="card-body" style={{ backgroundColor: "#000" }}>
        ...
        <p className="mb-4" style={{ fontSize: "1.1rem", color: "#ccc" }}>
          Total Questions: {questions.length} | Maximum Score: {assessment.maxScore}
        </p>
        <form
          onSubmit={(e) => {
            e.preventDefault();
          ...
          {questions.map((question, index) => (
            <div key={question.questionId} className="mb-5">
              ...
              <div className="d-flex flex-column gap-2">
                {(question.options?.$values || question.options || []).map((option) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <span className="form-check-label text-white">{option.text}</span>
                    </label>
                  );
                })}
              </div>
    ...
    <Modal show={modalVisible} onClose={() => setModalVisible(false)} title="Notice">
      <p style={{ backgroundColor: "#000", color: "#fff" }}>{modalMessage}</p>
    </Modal>
    </div>
  </>
);
