...
const ViewAssessmentResult = () => {
  ...
  if (!result || !result.questions || result.questions.length === 0) {
   ...
   return (
    <div className="container-fluid min-vh-100 bg-black text-white py-4 px-0" style={{ overflowX: "hidden" }}>
      ...
      <div className="container">
        ...
        <h3 className="text-white mb-4 fw-bold">Question Details</h3>
        {result.questions.map((question, idx) => {
          const options = question.allOptions?.$values || [];
          ...
          return (
            <div
              key={`question-${question.questionId || idx}`}
              className="card mb-4 bg-black text-white border-light"
            >
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-start mb-3">
                ...
                <div className="options">
                  {options.map((option, optionIdx) => {
                    ...
                    let optionClass =
                      "p-3 mb-2 border rounded bg-black text-white"; // base
                    if (isSelected && isCorrect) {
